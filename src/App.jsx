  ...
  return (
    <>
      <header className="header">
        <nav className="nav">
          {/* CATALOG */}
          <NavLink to="/" aria-label="Каталог" title="Каталог">
          ...
          {/* ADD BOOK */}
          <NavLink to="/add" aria-label="Додати книгу" title="Додати книгу">
            <svg className="nav__icon" viewBox="0 0 24 24" aria-hidden="true">
              <path d="M12 5v14" />
              <path d="M5 12h14" />
            </svg>

            <span className="nav__text">Додати книгу</span>
          </NavLink>

          {/* CALENDAR */}
          <NavLink to="/calendar" aria-label="Календар" title="Календар">
            <svg className="nav__icon" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <span className="nav__text">Календар</span>
          </NavLink>

          {/* USER / LOGIN */}
          <NavLink
            to={isAuthenticated ? "/account" : "/login"}
            aria-label={isAuthenticated ? "Мій акаунт" : "Увійти"}
            title={isAuthenticated ? "Мій акаунт" : "Увійти"}
            className={
              isAuthLoading
          ...
          >
            ...
            <span className="nav__text">
              {isAuthenticated ? "Мій акаунт" : "Увійти"}
            </span>
          </NavLink>
        </nav>
